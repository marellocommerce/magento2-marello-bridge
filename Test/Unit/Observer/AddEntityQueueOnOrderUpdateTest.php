...
use Marello\Bridge\Observer\CreateEntityQueueOnOrderUpdate;
...
class AddEntityQueueOnOrderUpdateTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->unit = new CreateEntityQueueOnOrderUpdate(
     ...
     * @test
     */
    public function testCreatingEntityQueueRecordOnOrderUpdate()
    {
